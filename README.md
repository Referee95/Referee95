...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,bash,vscode,github,git,visualstudio,html,css,react,js,django,python,ts,java,docker,mariadb)](https://skillicons.dev)
<br>
   <h2>
